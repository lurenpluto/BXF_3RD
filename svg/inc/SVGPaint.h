  ...
  public wxSVGColor
{
  ...
  public:
    ...
    inline const std::wstring& GetUri() const { return m_uri; }
    virtual void SetUri(const std::wstring& uri);
    ...
    virtual void SetPaint(wxSVG_PAINTTYPE paintType, const std::wstring& uri, const std::wstring& rgbColor, const std::wstring& iccColor);
};
