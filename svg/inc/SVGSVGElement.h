  ...
  public wxDocumentCSS
{
  protected:
    ...
    std::wstring m_contentScriptType;
    std::wstring m_contentStyleType;
  ...
  public:
    ...
    inline const std::wstring& GetContentScriptType() const { return m_contentScriptType; }
    inline void SetContentScriptType(const std::wstring& n) { m_contentScriptType = n; }

    inline const std::wstring& GetContentStyleType() const { return m_contentStyleType; }
    inline void SetContentStyleType(const std::wstring& n) { m_contentStyleType = n; }
  ...
  public:
    wxSVGSVGElement(std::wstring tagName = _T("svg")):
    ...
    wxSvgXmlElement* GetElementById(const std::wstring& elementId) const;
