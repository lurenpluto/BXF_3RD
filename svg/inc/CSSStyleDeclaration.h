...
typedef std::wstring wxCSSStyler;
...
class wxCSSStyleDeclaration: public wxHashMapCSSValue
{
  ...
  public:
    ...
    void SetCSSText(const std::wstring& text);
    
    inline std::wstring GetPropertyValue(const std::wstring& propertyName) const
    { return GetPropertyValue(GetPropertyId(propertyName)); }
    
    inline const wxCSSValue& GetPropertyCSSValue(const std::wstring& propertyName) const
    { return GetPropertyCSSValue(GetPropertyId(propertyName)); }
    
    void SetProperty(const std::wstring& propertyName, const std::wstring& value)
    { SetProperty(GetPropertyId(propertyName), value); }
    
    inline bool HasProperty(const std::wstring& propertyName) const
    { return HasProperty(GetPropertyId(propertyName)); }
    
    inline std::wstring RemoveProperty(const std::wstring& propertyName)
    { return RemoveProperty(GetPropertyId(propertyName)); }
  
  public:
    inline std::wstring GetPropertyValue(wxCSS_PROPERTY propertyId) const
    { const_iterator it = find(propertyId); if (it != end()) return it->second->GetCSSText(); return _T(""); }
    ...
    void SetProperty(wxCSS_PROPERTY propertyId, const std::wstring& value);
    inline bool HasProperty(wxCSS_PROPERTY propertyId) const { return find(propertyId) != end(); }
    inline std::wstring RemoveProperty(wxCSS_PROPERTY propertyId) { erase(propertyId); return _T(""); }
    
    static wxCSS_PROPERTY GetPropertyId(const std::wstring& propertyName);
    static std::wstring GetPropertyName(wxCSS_PROPERTY propertyId);
  ...
  public:
    ...
    inline std::wstring GetFontFamily() const
    {
      ...
      return it != end() ? ((wxCSSPrimitiveValue&)*it->second).GetStringValue() : _T("");
    }
    inline bool HasFontFamily() const { return HasProperty(wxCSS_PROPERTY_FONT_FAMILY); }
    inline void SetFontFamily(const std::wstring& value)
    {
  ...
  protected:
    ...
    static double ParseNumber(const std::wstring& value);
    static wxRGBColor ParseColor(const std::wstring& value);
    static void ParseSVGPaint(wxSVGPaint& paint, const std::wstring& value);
};
