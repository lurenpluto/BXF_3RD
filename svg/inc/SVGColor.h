  ...
  public wxCSSValue
{
  ...
  public:
    ...
    virtual void SetRGBColor(const std::wstring& rgbColor);
    virtual void SetRGBColorICCColor(const std::wstring& rgbColor, const std::wstring& iccColor);
    virtual void SetColor(wxSVG_COLORTYPE colorType, const std::wstring& rgbColor, const std::wstring& iccColor);
};
