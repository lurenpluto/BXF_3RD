...
class wxSVGStylable
{
  protected:
    ...
    bool HasCustomAttribute(const std::wstring& name);
    std::wstring GetCustomAttribute(const std::wstring& name);
    bool SetCustomAttribute(const std::wstring& name, const std::wstring& value);
  ...
  public:
    ...
    inline void SetClassName(const std::wstring& n) { m_className.SetBaseVal(n); }
  ...
  public:
    ...
    inline void SetFontFamily(const std::wstring& value) { m_style.SetFontFamily(value); }
    inline std::wstring GetFontFamily() { return m_style.GetFontFamily(); }
  ...
  public:
    ...
    virtual const wxCSSValue& GetPresentationAttribute(const std::wstring& name);
