...
public:
    ...
    wxHashTableBase_Node( const wchar_t* key, void* value,
                          wxHashTableBase* table );
    ~wxHashTableBase_Node();

    long GetKeyInteger() const { return m_key.integer; }
    const wchar_t* GetKeyString() const { return m_key.string; }
...
public:
    ...
    static long MakeKey(const wchar_t *string);

protected:
    void DoPut( long key, long hash, void* data );
    void DoPut( const wchar_t* key, long hash, void* data );
    void* DoGet( long key, long hash ) const;
    void* DoGet( const wchar_t* key, long hash ) const;
    void* DoDelete( long key, long hash );
    void* DoDelete( const wchar_t* key, long hash );
...
public:
    ...
    wxHashTable_Node( const wchar_t* key, void* value,
                      wxHashTableBase* table )
        : wxHashTableBase_Node( key, value, table ) { }
...
public:
    ...
    void Put(const wchar_t *value, wxObject *object)
        { DoPut( value, MakeKey( value ), object ); }
    void Put(long lhash, const wchar_t *value, wxObject *object)
        { DoPut( value, lhash, object ); }
    ...
    wxObject *Get(const wchar_t *value) const
        { return (wxObject*)DoGet( value, MakeKey( value ) ); }
    wxObject *Get(long lhash, const wchar_t *value) const
        { return (wxObject*)DoGet( value, lhash ); }
    ...
    wxObject *Delete(const wchar_t *key)
        { return (wxObject*)DoDelete( key, MakeKey( key ) ); }
    wxObject *Delete(long lhash, const wchar_t *key)
        { return (wxObject*)DoDelete( key, lhash ); }

    // Construct your own integer key from a string, e.g. in case
    // you need to combine it with something
    long MakeKey(const wchar_t *string) const
...
public:
    ...
    void Put(long key, const wchar_t *value, wxObject *object);
    ...
    wxObject *Get(long key, const wchar_t *value) const;
    ...
    wxObject *Delete(long key, const wchar_t *value);
